...
export const employeesSlice = createSlice({
    ...
    // The initial state value for this slice of state | allEmployees is an empty array. 
    ...
    reducers: {
        ...
        addMultipleEmployee: (state, { payload }) => {
...
export const { addMultipleEmployee } = employeesSlice.actions;
